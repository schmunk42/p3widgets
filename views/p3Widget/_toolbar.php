        ...
        <div class="btn-group">
            <?php
             $this->widget("bootstrap.widgets.TbButton", array(
                           ...
                           "size"=>"large",
                           "url"=>array("admin"),
                           "visible"=>$showManageButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.View")
                        ));
         ?>        </div>
    </div>
        ...
        <div class="btn-group">
            <?php
                   $this->widget("bootstrap.widgets.TbButton", array(
                       ...
                       "visible"=>$showCancelButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.View"),
                       "htmlOptions"=>array(
                                       "class"=>"search-button",
                                       "data-toggle"=>"tooltip",
                   ...
                   $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "type"=>"success",
                        "url"=>array("create"),
                        "visible"=>$showCreateButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.Create")
                   ));
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "visible"=> $showDeleteButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.Delete")
                    ));
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "visible"=> $showUpdateButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.Update")
                    ));
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "visible"=>$showViewButton && Yii::app()->user->checkAccess("P3widgets.P3Widget.View"),
                        "htmlOptions"=>array(
                                      "data-toggle"=>"tooltip",
