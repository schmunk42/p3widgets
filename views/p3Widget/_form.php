<div class="">
    ...
    <div class="row">
        ...
        <div class="span3">
            ...
            <div
                class='hint'><?php if ('help.controllerId' != $hint = Yii::t(
        ...
        <div class="span3">
            ...
            <div
                class='hint'><?php if ('help.requestParam' != $hint = Yii::t(
                        'P3WidgetsModule.crud',
                        'help.requestParam'
                    )
                ) {
    ...
    <div class="row">
        <div class="span3">
            ...
            <div
                class='hint'><?php if ('help.containerId' != $hint = Yii::t(
                        'P3WidgetsModule.crud',
                        'help.containerId'
                    )
                ) {
    ...
    <div class="row">
        <div class="span3">
            ...
            <div
                class='hint'><?php if ('help.sessionParam' != $hint = Yii::t(
                        'P3WidgetsModule.crud',
                        'help.sessionParam'
                    )
                ) {
