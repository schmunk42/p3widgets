...
<div class="clearfix">
    <div class="btn-toolbar pull-right">
        <!-- relations -->
                    <div class="btn-group">
                <?php  if (!Yii::app()->user->checkAccess('P3widgets.P3WidgetTranslation.SimpleUi') || Yii::app()->user->checkAccess('Admin')) {
        ...
        <div class="btn-group">
            <?php
             $this->widget("bootstrap.widgets.TbButton", array(
                           ...
                           "size"=>"large",
                           "url"=>array("admin"),
                           "visible"=>$showManageButton && (Yii::app()->user->checkAccess("P3widgets.P3WidgetTranslation.*") || Yii::app()->user->checkAccess("P3widgets.P3WidgetTranslation.View")) && (!Yii::app()->user->checkAccess("P3widgets.P3WidgetTranslation.SimpleUi") || Yii::app()->user->checkAccess("Admin"))
                        ));
         ?>        </div>
    </div>
