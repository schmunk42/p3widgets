...
<h1>
    ...
    <small><?php echo Yii::t('P3WidgetsModule.crud', 'Translation'); ?> #<?php echo $model->id ?></small>
</h1>
    ...
    $this->widget(
        ...
        array(
             ...
             'attributes' => array(
                 ...
                 array(
                     'name'  => 'p3_widget_id',
                     'value' => ($model->p3Widget !== null) ?
                         '<span class=label>CBelongsToRelation</span><br/>' . CHtml::link(
                             $model->p3Widget->alias,
                             array('p3Widget/view', 'id' => $model->p3Widget->id),
                             array('class' => 'btn')
                         ) : 'n/a',
                     'type'  => 'html',
                 ),
