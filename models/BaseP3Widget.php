...
abstract class BaseP3Widget extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            'id' => Yii::t('model', 'ID'),
            'name_id' => Yii::t('model', 'Name'),
            'status' => Yii::t('model', 'Status'),
            'default_properties_json' => Yii::t('model', 'Default Properties Json'),
            'default_content_html' => Yii::t('model', 'Default Content Html'),
            'module_id' => Yii::t('model', 'Module'),
            'controller_id' => Yii::t('model', 'Controller'),
            'action_name' => Yii::t('model', 'Action Name'),
            'request_param' => Yii::t('model', 'Request Param'),
            'session_param' => Yii::t('model', 'Session Param'),
            'container_id' => Yii::t('model', 'Container'),
            'rank' => Yii::t('model', 'Rank'),
            'alias' => Yii::t('model', 'Alias'),
            'access_owner' => Yii::t('model', 'Access Owner'),
            'access_domain' => Yii::t('model', 'Access Domain'),
